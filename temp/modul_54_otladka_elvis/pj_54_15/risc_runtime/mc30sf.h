...
//MFBSP_Ch0
#define	CSR_MFBSP_RX_CH0	*((volatile int *)0xB82F7800)
#define	CP_MFBSP_RX_CH0		*((volatile int *)0xB82F7804)
#define	IR_MFBSP_RX_CH0		*((volatile int *)0xB82F7808)
#define	RUN_MFBSP_RX_CH0	*((volatile int *)0xB82F780C)
//MFBSP_Ch1
#define	CSR_MFBSP_RX_CH1	*((volatile int *)0xB82F7840)
#define	CP_MFBSP_RX_CH1		*((volatile int *)0xB82F7844)
#define	IR_MFBSP_RX_CH1		*((volatile int *)0xB82F7848)
#define	RUN_MFBSP_RX_CH1	*((volatile int *)0xB82F784C)
//MFBSP_Ch2
#define	CSR_MFBSP_RX_CH2	*((volatile int *)0xB82F7880)
#define	CP_MFBSP_RX_CH2		*((volatile int *)0xB82F7884)
#define	IR_MFBSP_RX_CH2		*((volatile int *)0xB82F7888)
#define	RUN_MFBSP_RX_CH2	*((volatile int *)0xB82F788C)
//MFBSP_Ch3
#define	CSR_MFBSP_RX_CH3	*((volatile int *)0xB82F78C0)
#define	CP_MFBSP_RX_CH3		*((volatile int *)0xB82F78C4)
#define	IR_MFBSP_RX_CH3		*((volatile int *)0xB82F78C8)
#define	RUN_MFBSP_RX_CH3	*((volatile int *)0xB82F78CC)

//DMA SWIC ch Registers

//SWIC DMA
#define	SWIC_DMA(a)			*(volatile unsigned*)(0xB82FA800 + (a))

//SWIC DMA RX
#define	CSR_SWIC_RX_DES(i)	SWIC_DMA(0x0)
#define	CP_SWIC_RX_DES(i)	SWIC_DMA(0x4)
#define	IR_SWIC_RX_DES(i)	SWIC_DMA(0x8)
#define	RUN_SWIC_RX_DES(i)	SWIC_DMA(0xC)

#define	CSR_SWIC_RX_DAT(i)	SWIC_DMA(0x40)
#define	CP_SWIC_RX_DAT(i)	SWIC_DMA(0x44)
#define	IR_SWIC_RX_DAT(i)	SWIC_DMA(0x48)
#define	RUN_SWIC_RX_DAT(i)	SWIC_DMA(0x4C)

//SWIC DMA TX
#define	CSR_SWIC_TX_DES(i)	SWIC_DMA(0x80)
#define	CP_SWIC_TX_DES(i)	SWIC_DMA(0x84)
#define	IR_SWIC_TX_DES(i)	SWIC_DMA(0x88)
#define	RUN_SWIC_TX_DES(i)	SWIC_DMA(0x8C)

#define	CSR_SWIC_TX_DAT(i)	SWIC_DMA(0xC0)
#define	CP_SWIC_TX_DAT(i)	SWIC_DMA(0xC4)
#define	IR_SWIC_TX_DAT(i)	SWIC_DMA(0xC8)
#define	RUN_SWIC_TX_DAT(i)	SWIC_DMA(0xCC)

//SWIC 0 DMA RX
#define	CSR_SWIC_RX_DES0	*((volatile int *)0xB82FA800)
#define	CP_SWIC_RX_DES0		*((volatile int *)0xB82FA804)
#define	IR_SWIC_RX_DES0		*((volatile int *)0xB82FA808)
#define	RUN_SWIC_RX_DES0	*((volatile int *)0xB82FA80C)
#define	CSR_SWIC_RX_DAT0	*((volatile int *)0xB82FA840)
#define	CP_SWIC_RX_DAT0		*((volatile int *)0xB82FA844)
#define	IR_SWIC_RX_DAT0		*((volatile int *)0xB82FA848)
#define	RUN_SWIC_RX_DAT0	*((volatile int *)0xB82FA84C)

//SWIC 0 DMA TX
#define	CSR_SWIC_TX_DES0	*((volatile int *)0xB82FA880)
#define	CP_SWIC_TX_DES0		*((volatile int *)0xB82FA884)
#define	IR_SWIC_TX_DES0		*((volatile int *)0xB82FA888)
#define	RUN_SWIC_TX_DES0	*((volatile int *)0xB82FA88C)
#define	CSR_SWIC_TX_DAT0	*((volatile int *)0xB82FA8C0)
#define	CP_SWIC_TX_DAT0		*((volatile int *)0xB82FA8C4)
#define	IR_SWIC_TX_DAT0		*((volatile int *)0xB82FA8C8)
#define	RUN_SWIC_TX_DAT0	*((volatile int *)0xB82FA8CC)
