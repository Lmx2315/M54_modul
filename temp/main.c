 ...
 dsp->SYNC  = (0<<15) // «1»включается «Master» синхронизации
  ...
  dsp->ADC_CFG = (0<<15)
   ...
   dsp->RX_CFG = (0<<15) //wr_all  | «1» соответствует одновременной записи во все каналы
	...
	dsp-> RX1_DCICN = (2<<14) //Биты конфигурации 2-й ступени CIC–дециматора:- «112» - 2-й каскад децимации включен в режиме CIC6
					 ...
					 |(0 );//Регулировка уровня выходного сигнала 2-й ступени CIC-дециматора:- если scl_mx = 1, то коэффициент передачи CIC–дециматора

	dsp-> RX2_DCICN = 0x0000;
	dsp-> RX2_DCICN = (2<<14) //Биты конфигурации 2-й ступени CIC–дециматора:- «112» - 2-й каскад децимации включен в режиме CIC6
					 |(15<<8 ) //Коэффициент децимации 2-й ступени CIC-дециматора:M = dr + 1
					 |(0<<5 ) //Зарезервировано
					 |(1<<4 ) //Выбор диапазона регулировки уровня выходного сигнала 2-й ступени CIC-дециматора
					 |(0 );//Регулировка уровня выходного сигнала 2-й ступени CIC-дециматора:- если scl_mx = 1, то коэффициент передачи CIC–дециматора
	...
	dsp-> RX3_DCICN = (2<<14) //Биты конфигурации 2-й ступени CIC–дециматора:- «112» - 2-й каскад децимации включен в режиме CIC6
					 |(15<<8 ) //Коэффициент децимации 2-й ступени CIC-дециматора:M = dr + 1
					 |(0<<5 ) //Зарезервировано
					 |(1<<4 ) //Выбор диапазона регулировки уровня выходного сигнала 2-й ступени CIC-дециматора
					 |(0 );//Регулировка уровня выходного сигнала 2-й ступени CIC-дециматора:- если scl_mx = 1, то коэффициент передачи CIC–дециматора
	...
	dsp-> RX4_DCICN = (2<<14) //Биты конфигурации 2-й ступени CIC–дециматора:- «112» - 2-й каскад децимации включен в режиме CIC6
					 |(15<<8 ) //Коэффициент децимации 2-й ступени CIC-дециматора:M = dr + 1
					 |(0<<5 ) //Зарезервировано
					 |(1<<4 ) //Выбор диапазона регулировки уровня выходного сигнала 2-й ступени CIC-дециматора
					 |(0 );//Регулировка уровня выходного сигнала 2-й ступени CIC-дециматора:- если scl_mx = 1, то коэффициент передачи CIC–дециматора
	...
	dsp->RX1_DFIR1_CFG2 = (0<<4 ) //Зарезервировано
						 |(10);//Регулировка уровня выходного сигнала DFIR1.Коэффициент усиления на выходе DFIR1 равен 2scl-21
